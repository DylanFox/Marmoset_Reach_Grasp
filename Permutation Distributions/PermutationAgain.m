...
function [T_p,T_e] = PermutationAgain(MasterData,Parameter,AllPredictors)
...
E = categorical(TestData, [1:16], {'ECSL','ECSR','ECLL','ECLR','ELSL','ELSR','ELLL','ELLR','VCSL','VCSR','VCLL','VCLR','VLSL','VLSR','VLLL','VLLR'});
AllPredicotrs.ExpCohortFoodHand = E;
...
[T_p.ECSL(1),~,T_e.ECSL(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='ECSL'),Parameter(AllPredictors.ExpCohortFoodHand =='ELSL'),10000);
[T_p.ECSR(1),~,T_e.ECSR(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='ECSR'),Parameter(AllPredictors.ExpCohortFoodHand =='ELSR'),10000);
[T_p.ECLL(1),~,T_e.ECLL(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='ECLL'),Parameter(AllPredictors.ExpCohortFoodHand =='ELLL'),10000);
[T_p.ECLR(1),~,T_e.ECLR(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='ECLR'),Parameter(AllPredictors.ExpCohortFoodHand =='ELLR'),10000);
[T_p.VCSL(1),~,T_e.VCSL(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='VCSL'),Parameter(AllPredictors.ExpCohortFoodHand =='VLSL'),10000);
[T_p.VCSR(1),~,T_e.VCSR(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='VCSR'),Parameter(AllPredictors.ExpCohortFoodHand =='VLSR'),10000);
[T_p.VCLL(1),~,T_e.VCLL(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='VCLL'),Parameter(AllPredictors.ExpCohortFoodHand =='VLLL'),10000);
[T_p.VCLR(1),~,T_e.VCLR(1)] = permutationTest(Parameter(AllPredictors.ExpCohortFoodHand =='VCLR'),Parameter(AllPredictors.ExpCohortFoodHand =='VLLR'),10000);
end
