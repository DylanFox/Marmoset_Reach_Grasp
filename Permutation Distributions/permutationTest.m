...
if plotresult
    ...
    ylabel('Count')
    %od = plot(observeddifference, 0, '*r', 'LineWidth',2,'DisplayName', sprintf('Observed difference.\nEffect size: %.2f,\np = %f', effectsize, p));
    od = plot([observeddifference observeddifference], [0 1200], ':r', 'LineWidth',2,'DisplayName', sprintf('Observed difference.\nEffect size: %.2f,\np = %f', effectsize, p));
    legend(od);
end
