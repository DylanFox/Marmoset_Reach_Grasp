...
% Auto-generated by MATLAB on 03-Nov-2017 10:43:37
...
predictorNames = {'totaltime', 'mMGA', 'T2mMGA_pcnt', 'T2mMGA_ms', 'mMGA2end_ms', 'mMGA2end_pcnt', 'thumb_mVeloc', 'thumb_T2mVeloc_pcnt', 'thumb_T2mVeloc_ms', 'thumb_mVeloc2end_ms', 'thumb_mVeloc2end_pcnt', 'thumb_mAccel', 'thumb_T2mAccel_pcnt', 'thumb_T2mAccel_ms', 'thumb_mAccel2end_ms', 'thumb_mAccel2end_pcnt', 'AverageSpeed', 'AverageMGA', 'AverageAccel', 'FoodVolumeRounded'};
predictors = inputTable(:, predictorNames);
response = inputTable.HandUse;
...
includedPredictorNames = predictors.Properties.VariableNames([true true true true false false true true true false false true true true false false true true true false]);
predictors = predictors(:,includedPredictorNames);
isCategoricalPredictor = isCategoricalPredictor([true true true true false false true true true false false true true true false false true true true false]);
...
trainedClassifier.RequiredVariables = {'totaltime', 'mMGA', 'T2mMGA_pcnt', 'T2mMGA_ms', 'mMGA2end_ms', 'mMGA2end_pcnt', 'thumb_mVeloc', 'thumb_T2mVeloc_pcnt', 'thumb_T2mVeloc_ms', 'thumb_mVeloc2end_ms', 'thumb_mVeloc2end_pcnt', 'thumb_mAccel', 'thumb_T2mAccel_pcnt', 'thumb_T2mAccel_ms', 'thumb_mAccel2end_ms', 'thumb_mAccel2end_pcnt', 'AverageSpeed', 'AverageMGA', 'AverageAccel', 'FoodVolumeRounded'};
...
for fold = 1:KFolds
    ...
    % Data transformation: Select subset of the features
    % This code selects the same subset of features as were used in the app.
    includedPredictorNames = trainingPredictors.Properties.VariableNames([true true true true false false true true true false false true true true false false true true true false]);
    trainingPredictors = trainingPredictors(:,includedPredictorNames);
    foldIsCategoricalPredictor = foldIsCategoricalPredictor([true true true true false false true true true false false true true true false false true true true false]);
